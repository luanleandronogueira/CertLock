    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <center><h4><span id="msgCliente" class="badge text-bg-success form-section">Não encontramos esse cliente, preencha os dados e ele será cadastrado</span></h4></center>
                                            ...
                                            <div>
                                                <select class="form-control" name="item_venda" id="">
                                                    <?php foreach($Itens as $I) {?>
                                                        ...
                                                        <option value="<?=$I['id_item_preco'] . ' - ' . $I['preco_venda_item_preco'] . ' - ' . $I['modelo_item_preco'] . ' - ' . $I['custo_item_preco']?>"><?=$I['modelo_item_preco'] ?></option>
